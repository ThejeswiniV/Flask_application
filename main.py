...
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://gwc2023:gwc2023@34.100.137.118/gwcpmp"
engine = create_engine('mysql+pymysql://gwc2023:gwc2023@34.100.137.118/gwcpmp')
db = SQLAlchemy(app)
