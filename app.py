...
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://gwc2023:gwc2023@34.93.207.225/gwcpmp"
engine = create_engine('mysql+pymysql://gwc2023:gwc2023@34.93.207.225/gwcpmp')
db = SQLAlchemy(app)
